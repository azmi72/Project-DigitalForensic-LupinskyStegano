...
def click_EncodeScreen_Text():
    ...
    EncodeFrame_EntryBox1 = Entry(TextEncodeFrame_2,cursor='',textvariable=carrier_Entry,font=("Roboto",13),xscrollcommand=xscrollbar.set,width=33,state=DISABLED)
    ...
    Label(TextEncodeFrame3,text="    ",font=("Roboto",4),bg=Home_BACK_COL).pack(side=LEFT)
    Label(TextEncodeFrame3,text="Output Image",font=("Roboto",14,BOLD),relief=RAISED,bg=Banner_Colour_1,highlightthickness=3,highlightbackground=Banner_Colour_2).pack(side=LEFT)

    Label(mainWindow,text="  ",font=("Roboto",1),bg=Home_BACK_COL).pack()

    TextEncodeFrame_4 = Frame(mainWindow,bg=Home_BACK_COL)
    Label(TextEncodeFrame_4,text="    ",font=("Roboto",4),bg=Home_BACK_COL).pack(side=LEFT)

    xscrollbar2 = Scrollbar(TextEncodeFrame_4, orient=HORIZONTAL,bg=Home_BACK_COL)
    xscrollbar2.pack(side=BOTTOM,fill=BOTH)

    EncodeFrame_EntryBox2 = Entry(TextEncodeFrame_4,cursor='',font=("Roboto",13),width=33,textvariable=output_Entry,xscrollcommand=xscrollbar2.set,state=DISABLED)
    EncodeFrame_EntryBox2.pack(side=LEFT)
    xscrollbar2.config(command=EncodeFrame_EntryBox2.xview)

    Label(TextEncodeFrame_4,text="      ",font=("Roboto",4),bg=Home_BACK_COL).pack(side=LEFT)
    EncodeFrame_Button2 = Button(TextEncodeFrame_4,text="Select",font=("Roboto",12),width=6,height=1,command=choose_Output_file,state=DISABLED)
...
def exit_CON():
    a = messagebox.askquestion("Exit!","Yakin?")
    if a == "yes":
        mainWindow.destroy()
